...
; Unused - joenote: restored
	db $FF,66,TAUROS,67,EXEGGUTOR,68,ARCANINE,69,BLASTOISE,70,SNORLAX,0
	db $FF,66,TAUROS,67,GYARADOS,68,ARCANINE,69,VENUSAUR,70,SNORLAX,0
	db $FF,66,TAUROS,67,EXEGGUTOR,68,GYARADOS,69,CHARIZARD,70,SNORLAX,0
ChiefData:
; none
...
; Route 22
	db $FF,47,PIDGEOT,45,RHYHORN,45,ARCANINE,47,EXEGGCUTE,50,ALAKAZAM,53,BLASTOISE,0
